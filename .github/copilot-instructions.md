...
CSS in this repository follows FPM CSS Coding Conventions (SoT:
`rules/convention.yaml`). Follow the convention below when writing, generating, or
reviewing `**/*.css`. For details and good/bad examples, see
`.claude/skills/fpm-css/references/css-convention.md`.
